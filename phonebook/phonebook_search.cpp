...
void phonebook_search()
{
	...
	{
		if(strcmp(ad,contactsInfo.contact_name)==0 )   
		{												  
			found=1;	
			printf("%s",contactsInfo.contact_name);								  
			break;
		}
		else if(strcmp(ad,contactsInfo.contact_surname)==0)
		{
			found=1;	
			printf("%s",contactsInfo.contact_surname);								  
			break;
		}
	}
